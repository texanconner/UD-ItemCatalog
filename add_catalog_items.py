...
item1 = Item(name="Soccer Ball", description="kick it",
             category=category1, created_by='default')

session.add(item1)
session.commit()

item2 = Item(name="Soccer Shoes", description="Feet Gloves",
             category=category1, created_by='default')
...
item3 = Item(name="Hoop", description="Round and Orange",
             category=category2, created_by='default')
...
item4 = Item(name="Bat", description="Wood stick",
             category=category3, created_by='default')
